  ...
  public static void displayIt(File node, int start){
    if(node.isDirectory()){
      ...
      for(String filename : subNote){
        layerBuilder(node.getAbsolutePath().substring(start), filename);
...
//      allPath.add(node.getAbsolutePath().substring(start));
  ...
  public static void main(String[] args) throws IOException {
    ...
    ///Users/jingyiwang/Desktop/Marlin/GraphicalIDE/src/main
//    String srcPath = "/Users" + File.separator + "jingyiwang" + File.separator + "Desktop" + File.separator + "Marlin" + File.separator + "GraphicIDE_Maven" + File.separator + "src" + File.separator + "main" + File.separator + "java" + File.separator + "Main.java";
//    String srcPath = "/Users/jingyiwang/Desktop/Marlin/GraphicalIDE/src/main/java/Main.java";
    String srcPath = "/Users/jingyiwang/Desktop/Student_repo_Jingyi_Wang/Mid2019/src";
